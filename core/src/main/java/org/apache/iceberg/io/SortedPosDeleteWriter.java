...
class SortedPosDeleteWriter<T> implements V2Writer<PositionDelete<T>, V2DeleteWriterResult> {
  ...
  public V2DeleteWriterResult result() {
    ...
    return new V2DeleteWriterResult(completedFiles, referencedDataFiles);
  }
