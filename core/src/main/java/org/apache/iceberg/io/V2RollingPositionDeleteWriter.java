...
public class V2RollingPositionDeleteWriter<T> extends V2RollingDeleteWriter<PositionDelete<T>, PositionDeleteWriter<T>> {

  private final WriterFactory<T> writerFactory;

  public V2RollingPositionDeleteWriter(WriterFactory<T> writerFactory, OutputFileFactory fileFactory,
