...
public abstract class V2BaseRollingWriter<T, W extends V2Writer<T, R>, R extends Result> implements V2Writer<T, R> {
  ...
  protected V2BaseRollingWriter(OutputFileFactory fileFactory, FileIO io, FileFormat fileFormat,
