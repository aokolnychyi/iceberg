...
public class V2RollingEqualityDeleteWriter<T> extends V2RollingDeleteWriter<T, EqualityDeleteWriter<T>> {

  private final WriterFactory<T> writerFactory;

  public V2RollingEqualityDeleteWriter(WriterFactory<T> writerFactory, OutputFileFactory fileFactory,
