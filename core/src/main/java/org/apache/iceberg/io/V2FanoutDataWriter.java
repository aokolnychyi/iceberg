...
public class V2FanoutDataWriter<T> extends V2FanoutWriter<T, V2DataWriterResult> {
  ...
  public V2FanoutDataWriter(WriterFactory<T> writerFactory, OutputFileFactory fileFactory,
  ...
  @Override
  protected V2Writer<T, V2DataWriterResult> newWriter(PartitionSpec spec, StructLike partition) {
