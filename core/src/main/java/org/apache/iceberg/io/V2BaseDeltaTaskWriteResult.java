...
public class V2BaseDeltaTaskWriteResult implements V2DeltaTaskWriter.Result {
  private final DataFile[] dataFiles;
  private final DeleteFile[] deleteFiles;
  private final CharSequenceSet referencedDataFiles;

  public V2BaseDeltaTaskWriteResult(List<DataFile> dataFiles, List<DeleteFile> deleteFiles,
