...
public interface ExpireSnapshotsAction extends Action<ExpireSnapshotsAction.Result> {
   ...
   */
  ExpireSnapshotsAction executeDeleteWith(ExecutorService executorService);
   ...
   * @return this for method chaining
   */
  ExpireSnapshotsAction expireSnapshotId(long expireSnapshotId);
   ...
   * @return this for method chaining
   */
  ExpireSnapshotsAction expireOlderThan(long timestampMillis);
   ...
   * @return this for method chaining
   */
  ExpireSnapshotsAction retainLast(int numSnapshots);
   ...
   *
   * @param newDeleteFunc a function that will be called to delete manifests and data files
   * @return this for method chaining
   */
  ExpireSnapshotsAction deleteWith(Consumer<String> newDeleteFunc);
