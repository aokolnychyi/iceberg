...
import org.apache.spark.sql.connector.write.CopyOnWriteOperationsBuilder;
...
class SparkCopyOnWriteOperationsBuilder implements CopyOnWriteOperationsBuilder {
  ...
  public SparkCopyOnWriteOperationsBuilder(SparkSession spark, Table table, LogicalWriteInfo info) {
    this.spark = spark;
    this.table = table;
  ...
  @Override
  public CopyOnWriteOperationsBuilder pushDownOverwriteFilters(Filter[] filters) {
